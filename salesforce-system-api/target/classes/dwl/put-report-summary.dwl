...
[{
	...
	LastComment__c: payload.reportSummary[0].lastComment,
	ExpenseUserLoginID__c: payload.reportSummary[0].expenseUserLoginId,
	ApproverLoginID__c: payload.reportSummary[0].approverLoginId,
